...
![Key Vault run trigger](images/kv_run_trigger.png)
![Key Vault Workspace Apply](images/kv_workspace_apply.png)
![Primary Workspace run triggered](images/primary_workspace_triggered.png)
